    ...
    tabs: [
        {
            ...
            items: [
                {
                    title: '교육 자료 생성',
                    description: '효과적인 학습을 위한 다양한 교육 자료를 생성합니다.',
                    details: ['교육 커리큘럼 설계', '학습 목표 설정', '내용 구성', '평가 방법 개발']
                },
                {
                    title: '멀티미디어 컨텐츠',
                    description: '시각적, 청각적 요소를 활용한 멀티미디어 학습 컨텐츠를 제작합니다.',
                    details: ['영상 콘텐츠 제작', '오디오 자료 개발', '인터랙티브 애니메이션', '3D 시각화']
                },
                {
                    title: '인터랙티브 자료',
                    description: '학습자의 참여를 유도하는 인터랙티브 학습 자료를 개발합니다.',
                    details: ['상호작용 시뮬레이션', '게임화 요소', '실시간 피드백', '협력 학습 도구']
                },
                {
                    title: '개인화 학습 자료',
                    description: '개별 학습자의 특성에 맞춘 맞춤형 학습 자료를 제공합니다.',
                    details: ['적응형 콘텐츠', '수준별 자료', '학습 스타일 맞춤', '개인 진도 반영']
                }
            ]
        },
        {
