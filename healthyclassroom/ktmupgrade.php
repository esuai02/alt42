    ...
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold flex items-center">
                                KTM 통합 진단 시스템
                                <span class="ml-2 text-xs bg-green-400 text-green-900 px-2 py-1 rounded-full">v2.5</span>
                            </h1>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button class="px-4 py-2 bg-white text-blue-900 rounded-lg hover:bg-blue-50 transition-colors font-medium">
                            KTM 리포트 생성
                        </button>
                    </div>
                </div>
            ...
            <div class="px-6 py-4">
                <div class="grid grid-cols-5 gap-4">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-600"><?php echo $ktmMetrics['learningEfficiency']; ?>%</div>
                        <div class="text-sm text-gray-600">학습 효율성</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-600"><?php echo $ktmMetrics['teachingQuality']; ?>%</div>
                        <div class="text-sm text-gray-600">교육 품질</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-purple-600"><?php echo $ktmMetrics['parentSatisfaction']; ?>%</div>
                        <div class="text-sm text-gray-600">학부모 만족도</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-orange-600"><?php echo $ktmMetrics['goalAchievementRate']; ?>%</div>
                        <div class="text-sm text-gray-600">목표 달성률</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-indigo-600"><?php echo $ktmMetrics['systemReliability']; ?>%</div>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-6 gap-4 mb-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-purple-500">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <i data-lucide="brain" class="text-purple-600 w-5 h-5"></i>
                    </div>
                    <div class="text-2xl font-bold"><?php echo $ktmStats['avgMetaCognition']; ?>%</div>
                    <p class="text-xs text-purple-600 mt-1">안정적</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-indigo-500">
                    ...
                    <p class="text-xs text-indigo-600 mt-1">+5.1% ↑</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-red-500">
                    ...
                    <div class="text-2xl font-bold text-red-600"><?php echo $ktmStats['atRiskStudents']; ?>명</div>
                    <p class="text-xs text-red-600 mt-1">즉시 개입 필요</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-emerald-500">
                    ...
                    <div class="text-2xl font-bold text-emerald-600"><?php echo $ktmStats['excellentStudents']; ?>명</div>
                    <p class="text-xs text-emerald-600 mt-1">상위 24%</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold flex items-center">
                                <i data-lucide="shield" class="mr-2 text-blue-600 w-5 h-5"></i>
                                KTM 진단 모듈 현황
                            </h3>
                            <div class="flex space-x-2">
                                <button data-filter="all" class="filter-btn px-3 py-1 text-sm rounded-lg bg-blue-600 text-white">전체</button>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <h3 class="text-lg font-semibold mb-4 flex items-center">
                            <i data-lucide="bar-chart-3" class="mr-2 text-blue-600 w-5 h-5"></i>
                            KTM 성과 분포 분석
                        </h3>
                        ...
                        <div class="border-t pt-4">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <div class="text-center p-3 bg-blue-50 rounded-lg">
                                    <div class="text-lg font-bold text-blue-600">15명</div>
                                    <div class="text-xs text-gray-600">2주 내 위험군 전환 예상</div>
                                </div>
                                <div class="text-center p-3 bg-green-50 rounded-lg">
                                    <div class="text-lg font-bold text-green-600">23명</div>
                ...
                <div class="space-y-6">
                    <!-- 긴급 알림 -->
                    <div class="bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg p-4 shadow-lg">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <button class="mt-2 bg-white text-red-600 px-3 py-1 rounded text-sm font-medium hover:bg-red-50 transition-colors">
                                    긴급 대응 프로토콜 실행
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <h3 class="text-lg font-semibold mb-4 flex items-center">
                            <i data-lucide="alert-triangle" class="mr-2 text-orange-600 w-5 h-5"></i>
                            KTM 집중 관리 대상
                        </h3>
                        <div class="space-y-3">
...
function getTrendIcon($trend) {
    if ($trend === 'up') return '<i data-lucide="trending-up" class="text-green-500 w-3.5 h-3.5"></i>';
    if ($trend === 'down') return '<i data-lucide="trending-up" class="text-red-500 rotate-180 w-3.5 h-3.5"></i>';
